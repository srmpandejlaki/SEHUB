const translations = {
  id: {
    ...
    updateBtn: "Perbarui",
    updateDesc: "Memperbarui data...",
    updateSuccess: "Data berhasil diperbarui!",
    addSuccess: "Data berhasil ditambahkan!",
    updateFailed: "Gagal memperbarui data",
    addFailed: "Gagal menambahkan data",
    reportBtn: "Laporan",
    no: "No",
    noProducts: "Belum ada produk.",
    dateRequired: "Mohon lengkapi tanggal masuk",
    minOneProductWithDate: "Mohon tambahkan minimal satu produk dengan jumlah dan tanggal expired",
    ...
    back: "Kembali",
    stockHistoryPerBatch: "Riwayat Stok (Per Batch)",
    loadingStockData: "Memuat data stok...",
    initialAmount: "Jumlah Awal",
    noStockHistory: "Belum ada riwayat stok.",
    available: "Tersedia",
    outOfStock: "Habis",
    expired: "Kadaluwarsa",
    productListTitle: "Daftar Produk L' Arbre Seho",
    weight: "Berat Barang",
    noProductFound: "Belum ada produk.",
    searchPlaceholder: "Cari produk...",

    // Additional Stock Adjustment
    adjustNow: "Sesuaikan Sekarang",
    adjustmentNote: "Catatan Penyesuaian (opsional)",
    warehouseStockAmount: "Jumlah di Gudang",
    reasonForDiscrepancy: "Alasan Tidak Sesuai",
    satisfied: "SESUAI",
    fillOneAdjustment: "Mohon isi minimal satu data penyesuaian",
    successAdjustment: "Penyesuaian stok berhasil!",
    failedAdjustment: "Gagal menyimpan penyesuaian stok",
    adjustPlaceholder: "Masukkan catatan...",

    // Additional Distribution & Return
    returnFormTitle: "Form Return Barang",
    selectReturnedProduct: "Pilih Produk yang Direturn:",
    returnAmount: "Jumlah Return:",
    returnNote: "Catatan Return",
    returnHistory: "Riwayat Return:",
    saveReturn: "Simpan Return",
    saveChanges: "Simpan Perubahan",
    returnReasonPlaceholder: "Alasan return (opsional)",
    selectMethod: "-- Pilih Metode --",
    selectStatus: "-- Pilih Status --",
    buyerPlaceholder: "Masukkan nama pemesan",
    returnSuccess: "Return barang berhasil dibuat!",
    returnFailed: "Gagal membuat return barang",
    distributeSuccess: "Data distribusi berhasil diperbarui!",
    distributeFailed: "Gagal memperbarui data distribusi",
    allFieldsRequired: "Mohon lengkapi semua field yang wajib diisi",
    minOneProduct: "Mohon tambahkan minimal satu produk",
    dateReturnRequired: "Tanggal return wajib diisi",
    minOneReturn: "Pilih minimal satu produk dan isi jumlah return",
    returnQtyError: "Jumlah return untuk {name} tidak boleh melebihi jumlah distribusi ({max})",
    availableStockInSystem: "Jumlah Stok Tersedia di Sistem",
    seeDetail: "lihat detail",
    overStockError: "⚠️ Melebihi stok! (Tersedia: {stock})",
    generalOverStockError: "Jumlah produk melebihi stok yang tersedia. Silakan periksa kembali.",
  },
  en: {
    // Header
    ...
    dateRequired: "Please complete the entry date",
    minOneProductWithDate: "Please add at least one product with quantity and expiry date",
    ...
    // Additional Product & Inventory
    back: "Back",
    stockHistoryPerBatch: "Stock History (Per Batch)",
    loadingStockData: "Loading stock data...",
    initialAmount: "Initial Amount",
    noStockHistory: "No stock history found.",
    available: "Available",
    outOfStock: "Out of Stock",
    expired: "Expired",
    productListTitle: "L' Arbre Seho Product List",
    ...
    adjustmentNote: "Adjustment Note (optional)",
    warehouseStockAmount: "Warehouse Amount",
    reasonForDiscrepancy: "Reason for Discrepancy",
    satisfied: "SATISFIED",
    fillOneAdjustment: "Please fill at least one adjustment data",
    successAdjustment: "Stock adjustment successful!",
    failedAdjustment: "Failed to save stock adjustment",
    adjustPlaceholder: "Enter note...",

    // Additional Distribution & Return
    returnFormTitle: "Return Product Form",
    selectReturnedProduct: "Select Returned Product:",
    ...
    returnSuccess: "Return product successfully created!",
    returnFailed: "Failed to create return product",
    distributeSuccess: "Distribution data successfully updated!",
    distributeFailed: "Failed to update distribution data",
    allFieldsRequired: "Please complete all required fields",
    minOneProduct: "Please add at least one product",
    dateReturnRequired: "Return date is required",
    minOneReturn: "Please select at least one product and enter return quantity",
    returnQtyError: "Return quantity for {name} cannot exceed distribution quantity ({max})",
    availableStockInSystem: "Available Stock Quantity in System",
    seeDetail: "see detail",
    overStockError: "⚠️ Over stock! (Available: {stock})",
    generalOverStockError: "Product quantity exceeds available stock. Please double-check.",
  }
};
